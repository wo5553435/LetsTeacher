...
/**
 * Created by sinner on 2017-09-01.
...
public class PickerScrollView extends View {
    ...
    private List<IndexString> mDataList;
    /**
    ...
    private void performSelect() {
        if (mSelectListener != null)
            mSelectListener.onSelect(mDataList.get(mCurrentSelected).position,mDataList.get(mCurrentSelected).value);
    }

    public void setData(List<IndexString> datas) {
        mDataList = datas;
    ...
    private void moveHeadToTail() {
        IndexString head = mDataList.get(0);
        mDataList.remove(0);
        mDataList.add(head);
    }

    private void moveTailToHead() {
        IndexString tail = mDataList.get(mDataList.size() - 1);
    ...
    private void drawData(Canvas canvas) {
        ...
        String textData = mDataList.get(indexs).value;
    ...
    public interface onSelectListener {
        void onSelect(int positon, String pickers);
    }

   public static  class IndexString{
        int position =-1;
        String value="";
        public IndexString(int position,String str){
