...
//            progressView.setImageDrawable(getResources().getDrawable(R.drawable.animate_check));
//            mProgressBar.setView(progressView);
//        }else
        {
            AVLoadingIndicatorView progressView = new  AVLoadingIndicatorView(context);
            progressView.setIndicatorColor(0xffffff);
    ...
    public void setProgressStyle(int style) {
        if(style == ProgressStyle.SysProgress){
            ...
            /*if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ImageView progressView=new ImageView(mContext);
                progressView.setImageDrawable(getResources().getDrawable(R.drawable.animate_check));
                mProgressBar.setView(progressView);
            }else*/
                {
...
//            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
//            Drawable drawable= ((ImageView)mProgressBar.getChildAt(0)).getDrawable();
